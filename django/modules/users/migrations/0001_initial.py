# Generated by Django 3.2.16 on 2023-01-27 19:29
...
import modules.users.models.managers.custom_user_manager
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verification_secret', models.CharField(max_length=256)),
                ('is_confirmed', models.BooleanField(default=False)),
                ('wrong_password_count', models.SmallIntegerField(default=0)),
            ...
            managers=[
                ('objects', modules.users.models.managers.custom_user_manager.CustomUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='UserToken',
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE,
                 related_name='auth_token', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'verbose_name': 'Token',
